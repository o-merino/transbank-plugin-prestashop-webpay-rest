 ...
 */
class WebPayWebpayplusPaymentValidateCreditModuleFrontController extends PaymentModuleFrontController
{
    ...
    private function handleAuthorizedTransaction(
        ...
        $this->logInfo("depurando {$cart->id_customer} {$currency} {$cart->id}");
        $this->logInfo("depurando 11");
